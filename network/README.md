...
Objetivo é gerar os certificados digitais x.509 e as chaves de assinatura para todos os participantes da rede. Isso será importante para conseguirmos as permissões para cada agente estar na rede.
~~~sh
