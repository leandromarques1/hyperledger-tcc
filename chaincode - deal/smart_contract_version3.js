...
//const NameOrg = require('./nameOrg.js');
...
class SupplychainContract extends Contract {
    ...
    */
    ...
    //async nome_organizacao(){
    //    return name_org_teste;
    //}
    ...
    async createProduct (ctx, product_ID, productName, cnpj_produtor) {
        // → product_ID: nº de identificação do produto
        ...
        //Passo 1: verificar se Produto já existe dentro da Rede
        ...
        // #== Descobrindo em qual Organização o chaincode está ==#
        var nodeName = await this.name_org(ctx);
        //{}
        // #==================================#

        
        //Passo 2: método exclusivo para "Produtor"
    ...
    async updateProduct (ctx, product_ID, productName, CNPJ) {
    ...
    async deleteProduct (ctx, product_ID) {
